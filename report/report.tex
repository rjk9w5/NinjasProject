...
\begin{figure}[htb]% order of placement preference: here, top, bottom
  \caption{Convergence plot from the solution of the 10x10 grid}
  \begin{subfigmatrix}{2}
    \subfigure[Iteration vs N]{\includegraphics{sd_err}}
    \subfigure[Time vs N]{\includegraphics{time_study}}
    \subfigure[Total Error vs N]{\includegraphics{lieb_err}}
  \end{subfigmatrix}
 \label{f:p_convergeplot}
\end{figure}
...
\lstlisting[caption=g++ with O3 optimization flag]{../outputgpp}
\lstlisting[caption=g++ with Ofast optimization flag]{../outputgppfast}
\lstlisting[caption=clang++ with O3 optimization flag]{../outputclang}
